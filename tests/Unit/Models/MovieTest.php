...
class MovieTest extends UnitTestCase {
	...
	public function test_constructor_default_quality_is_1080p_2160p(): void {
		$movie = new Movie( $this->valid_attrs() );
		$this->assertSame( '1080p,2160p', $movie->get_quality() );
	}

	public function test_get_quality_returns_constructor_value(): void {
		$movie = new Movie( $this->valid_attrs( [ 'quality' => '1080p,2160p' ] ) );
		$this->assertSame( '1080p,2160p', $movie->get_quality() );
	}

	public function test_set_quality_round_trip_with_csv_value(): void {
		$movie = new Movie( $this->valid_attrs() );
		$movie->set_quality( '720p,2160p' );
		$this->assertSame( '720p,2160p', $movie->get_quality() );
	}
